...
import static ir.mahdiparastesh.mcdtp.time.Timepoint.TYPE.HOUR;
import static ir.mahdiparastesh.mcdtp.time.Timepoint.TYPE.MINUTE;
...
public class Timepoint implements Parcelable, Comparable<Timepoint> {
    ...
    public static final Parcelable.Creator<Timepoint> CREATOR = new Parcelable.Creator<>() {
