...
import ir.mahdiparastesh.mcdtp.GravitySnapHelper;
import ir.mahdiparastesh.mcdtp.McdtpUtils;
import ir.mahdiparastesh.mcdtp.date.DatePickerDialog.OnDateChangedListener;

@SuppressWarnings("unchecked")
public abstract class DayPickerView<CAL extends Calendar> extends RecyclerView
    ...
    void accessibilityAnnouncePageChanged() {
        ...
        if (mv != null) {
            ...
            McdtpUtils.tryAccessibilityAnnounce(this, monthYear);
        }
    }
